<!-- AUTO-GENERATED FROM kolbo-code@2d43295 — DO NOT EDIT THIS FILE DIRECTLY.
     Source of truth: github.com/Zoharvan12/kolbo-code
     Path:            packages/opencode/skills/kolbo/ (SKILL.md + references/**)
     Synced by:       .github/workflows/sync-skill-to-plugin.yml in kolbo-code
     To make changes: edit the source files in kolbo-code and push;
                      this workflow mirrors the whole skills/kolbo/ tree here
                      and bumps the plugin patch version.
-->
