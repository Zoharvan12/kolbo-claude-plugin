<!-- AUTO-GENERATED — DO NOT EDIT THIS FILE DIRECTLY.
     ...
     Synced by:       .github/workflows/sync-skill.yml in kolbo-code
     To make changes: edit the source file in kolbo-code and the workflow
                      will push an update commit + version bump here.
-->
