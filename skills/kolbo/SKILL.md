<!-- AUTO-GENERATED FROM kolbo-code@d455799 — DO NOT EDIT THIS FILE DIRECTLY.
     Source of truth: github.com/Zoharvan12/kolbo-code
     Path:            packages/opencode/skills/kolbo/SKILL.md
     Synced by:       .github/workflows/sync-skill-to-plugin.yml in kolbo-code
     To make changes: edit the source file in kolbo-code and push;
                      this workflow will push an update commit + version bump here.
-->
